...
func TestPounceDirectory_NonExistentDirectory(t *testing.T) {
...
func TestFileHandleManager_ScratchString(t *testing.T) {
	manager := NewFileHandleManager()
	testDir := t.TempDir()
	testFile := filepath.Join(testDir, "scratchstring_test.txt")
